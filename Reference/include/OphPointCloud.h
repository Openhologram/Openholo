...
class GEN_DLL OphPointCloud : public OphGeneration
{
public:
	/**
	* @brief Constructor
...
public:
	...
	*/
	void setConfigParams(const oph::OphConfigParams &InputConfig);

	oph::OphConfigParams getConfigParams();
	/** @} */
...
private:
	...
	*/
	...
	oph::OphConfigParams ConfigParams;
	uchar *data_hologram;
};
