...
void ophPointCloud::genCghPointCloudGPU(uint diff_flag)
{
	...
	//float3 *HostPointCloud = (float3*)pc_data_.vertex;
	//Real *hostAmplitude = (Real*)pc_data_.color;
	...
	//	HostConfig.sin_thetaX = sin(thetaX);
	//	HostConfig.sin_thetaY = sin(thetaY);
...
void ophPointCloud::diffractEncodedRS_GPU(void)
{
}

void ophPointCloud::diffractNotEncodedRS_GPU(void)
{
}

void ophPointCloud::diffractEncodedFrsn_GPU(void)
{
}

void ophPointCloud::diffractNotEncodedFrsn_GPU(void)
{
}
