...
public:
	/**
	* @brief If referenced this(Base's child class, not abstract class) instance, must call this method.
	*/
...
protected:
	/**
	* @brief When refCnt is 0 (zero), it is called inside release () when release () is called. 
